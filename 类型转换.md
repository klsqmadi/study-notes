...
```
//有6种数据类型
Number String Boolean Null Undefined Object(对象类型)(Array,Function,Date,RegExp)
...
//如何判断数据类型
1.typeof：返回一个表示数据类型的字符串(Number,String,Boolean,Null,Undefined,Object,Function(这是特殊的))
